...
namespace PumpkinRun.UI.MVC.Controllers
{
    public class ContactController : Controller
    {
        ...
        public IActionResult Contact(ContactViewModel cvm)
        {
            ...
            mm.From.Add(new MailboxAddress("Pumpkin Run/Walk", _config.GetValue<string>("Credentials:Email:User")));

            //The recipient of this email will be our personal email address, which is also
            //stored is appseting.json

            mm.To.Add(new MailboxAddress("Recipient1", _config.GetValue<string>("Credentials:Email:Recipient1")));
            mm.To.Add(new MailboxAddress("Recipient2", _config.GetValue<string>("Credentials:Email:Recipient2")));
            mm.To.Add(new MailboxAddress("Recipient3", _config.GetValue<string>("Credentials:Email:Recipient3")));
            ...
            using (var client = new SmtpClient())
            {
                ...
                //client.Connect("mail.pumpkinrunwalk.com");
